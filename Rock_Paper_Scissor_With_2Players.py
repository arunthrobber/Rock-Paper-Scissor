...
# here inputting the choice by first player among Rock/Paper/Scissor
input1 = input(
    f"{Player1} ---->  please enter your choice: Rock/Paper/Scissor :  ")
# I did the star print for hidding input by player 1
print("*****************************************************\n" * 40)
# here inputting the choice by second player among Rock/Paper/Scissor
input2 = input(
    f"{Player2}---->  please enter your choice: Rock/Paper/Scissor :  ")
if input1 and input2:  # this is for truthiness and falsiness if user don't enter anything that means empty string
    ...
    if input1 == "Rock" and input2 == "Paper":
        ...
        print("Ohh it's a conincidence , your choices matched ,please play gaian ")
    else:
